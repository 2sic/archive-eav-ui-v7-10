...
$templateCache.put("localization/language-switcher.html","<uib-tabset>\r\n    <uib-tab ng-repeat=\"l in languages.languages\" heading=\"{{ l.name.substring(0, l.name.indexOf(\'(\') > 0 ? l.name.indexOf(\'(\') - 1 : 100 ) }}\" ng-click=\"!isDisabled ? languages.currentLanguage = l.key : false;\" disable=\"isDisabled\" tooltip=\"{{l.name}}\"></uib-tab><!-- active=\"languages.currentLanguage == l.key\" -->\r\n</uib-tabset>");
